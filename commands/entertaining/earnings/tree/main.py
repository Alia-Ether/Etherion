...
@antispam
async def tree_cmd(message: types.Message, user: EtherionUser):
...
@antispam
async def my_tree(message: types.Message, user: EtherionUser):
...
async def edit_tree_msg(call: types.CallbackQuery | types.Message, user: EtherionUser, action='edit') -> None:
    tree = user.tree
...
@antispam
async def buy_tree(message: types.Message, user: EtherionUser):
    win, lose = EtherionConst.emj()
    tree = user.tree
...
@antispam_earning
async def buy_ter(call: types.CallbackQuery, user: EtherionUser):
    win, lose = EtherionConst.emj()
    tree = user.tree
...
@antispam_earning
async def buy_tree_call(call: types.CallbackQuery, user: EtherionUser):
    win, lose = EtherionConst.emj()
    tree = user.tree
...
@antispam
async def sell_tree(message: types.Message, user: EtherionUser):
    win, lose = EtherionConst.emj()
    tree = user.tree
