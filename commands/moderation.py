...
@antispam
@moderation
async def mute_cmd(message: types.Message, user: EtherionUser):
...
@antispam
@moderation
async def unmute_cmd(message: types.Message, user: EtherionUser):
	chat_id = message.chat.id
...
@antispam
@moderation
async def ban_cmd(message: types.Message, user: EtherionUser):
	chat_id = message.chat.id
...
@antispam
@moderation
async def unban_cmd(message: types.Message, user: EtherionUser):
	chat_id = message.chat.id
